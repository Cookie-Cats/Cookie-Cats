        ...
        <div class="form-container">
            <form action="" method="post" onsubmit="submitForm()">
                ...
                <div class="form-item-box">
                    ...
                    <input type="password" name="WiFi_PASSWORD" id="WiFi_PASSWORD" placeholder="认证路由密码" class="input-item"/>
                    <input type="text" name="Cookie_Cat_SSID" id="Cookie_Cat_SSID" placeholder="Cookie-Cats无线名" class="input-item"/>
                    <input type="password" name="Cookie_Cat_PASSWORD" id="Cookie_Cat_PASSWORD" placeholder="Cookie-Cats无线密码" class="input-item"/>
